                                    ...
                                    <Col md={12}>
                                        ...
                                        <div className="arrival-flight-group-accordion">
                                            ...
                                            {flights && flights.map(flight => (
                                                <div className="group" key={flight.id}>
                                                ...
                                                <div className="flightinfo_wrapper">
                                                    ...
                                                    <div className="flightinfo" key={i}>
                                                        <div className="upper">
                                                        <div className="airlinelogo">
                                                            <img src={seg.airline} alt="" className="img-fluid" />
                                                        </div>

                                                        <div className="flybox">
                                                            <div className="flyfrom">
                                                            <div className="time">{seg.fromTime}</div>
                                                            <div className="location">{seg.fromLocation}</div>
                                                            </div>

                                                            <div className="duration">
                                                            <div className="flightduration">{seg.duration}</div>
                                                            <div className="line"></div>
                                                            <div className="stops">{seg.stops}</div>
                                                            </div>

                                                            <div className="flyto">
                                                            <div className="time">{seg.toTime}</div>
                                                            <div className="location">{seg.toLocation}</div>
                                                            </div>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    {/* Expandable Arrow */}
                                                    <div
                                                    className={`expandable arrow ${openIndex === flight.id ? "open" : ""}`}
                                                    onClick={() => toggle(flight.id)}
                                                    ></div>

                                                    {/* Expandable Content */}
                                                    <div className={`expandable-wrapper ${openIndex === flight.id ? "show" : ""}`}>
                                                    
                                                    {/* Departure */}
                                                    <div className="departure">
                                                        <div className="card">
                                                            <div className="flight-header">
                                                                <div className="direction-status">Depart  <span>{flight.details.departure.date}</span></div>
                                                                <div>{flight.details.departure.duration}</div>
                                                            </div>
                                                            <div className="flight-segment">
                                                                <div className="header">
                                                                    <img src={flight.details.departure.airline} className="airline-logo" alt="" />
                                                                    <span className="flight-number">{flight.details.departure.airlinename}</span>
                                                                    <span className="aircraft">{flight.details.departure.flightNumber}</span>
                                                                    <span className="aircraft">{flight.details.departure.aircraft}</span>
                                                                </div>
                                                                <div className="flight-content">
                                                                    ...
                                                                    <div className="schedule">
                                                                        <div className="direction">
                                                                            <div className="time">{flight.details.departure.schedule.fromTime}</div>
                                                                            <div className="location">{flight.details.departure.schedule.fromAirport}</div>
                                                                        </div>
                                                                        <div className="duration">{flight.details.departure.duration}</div>
                                                                        <div className="direction">
                                                                            <div className="time">{flight.details.departure.schedule.toTime}</div>
                                                                            <div className="location">{flight.details.departure.schedule.toAirport}</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div className="departure">
                                                        <div className="card">
                                                            <div className="flight-header">
                                                                <div className="direction-status">Return  <span>{flight.details.return.date}</span></div>
                                                                <div>{flight.details.return.duration}</div>
                                                            </div>
                                                            <div className="flight-segment">
                                                                <div className="header">
                                                                    <img src={flight.details.return.airline} className="airline-logo" alt="" />
                                                                    <span className="flight-number">{flight.details.return.airlinename}</span>
                                                                    <span className="aircraft">{flight.details.return.flightNumber}</span>
                                                                    <span className="aircraft">{flight.details.return.aircraft}</span>
                                                                </div>
                                                                <div className="flight-content">
                                                                    <div className="timeline">
                                                                        <span className="dot"></span>
                                                                    ...
                                                                    <div className="schedule">
                                                                        <div className="direction">
                                                                            <div className="time">{flight.details.return.schedule.fromTime}</div>
                                                                            <div className="location">{flight.details.return.schedule.fromAirport}</div>
                                                                        </div>
                                                                        <div className="duration">{flight.details.return.duration}</div>
                                                                        <div className="direction">
                                                                            <div className="time">{flight.details.return.schedule.toTime}</div>
                                                                            <div className="location">{flight.details.return.schedule.toAirport}</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
